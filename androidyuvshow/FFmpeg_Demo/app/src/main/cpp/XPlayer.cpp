...
Java_huizai_ffmpeg_AVPlayer_OpenFileWithUrl(
        JNIEnv *env,
        jobject obj,
        jstring input)
{
...
Java_huizai_ffmpeg_AVPlayer_ReadPkt(
        JNIEnv *env,
        jobject obj)
{
...
extern "C" JNIEXPORT jint JNICALL
Java_huizai_ffmpeg_AVPlayer_DecodeAudio(
        JNIEnv *env,
        jobject obj,
        jint ptrAddress
        )
...
extern "C" JNIEXPORT jint JNICALL
Java_huizai_ffmpeg_AVPlayer_DecodeVideo(
        JNIEnv *env,
        jobject obj,
        jint ptrAddress
        )
...
extern "C" JNIEXPORT jint JNICALL
Java_huizai_ffmpeg_AVPlayer_SetPlayRate(
        JNIEnv *env,
        jobject obj,
        jint playRate
)
...
extern "C" JNIEXPORT void JNICALL
Java_huizai_ffmpeg_AVPlayer_SetPlayAudioOrVideoRate(
        JNIEnv *env,
        jobject obj,
        jint avPlayRate
)
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_huizai_ffmpeg_GLRenderer_InitOpenGL(
        JNIEnv *env,
        jobject obj)
{
    initGL();
...
extern "C" JNIEXPORT void JNICALL
Java_huizai_ffmpeg_GLRenderer_OnViewportChanged(
        JNIEnv *env,
        jobject obj,
        jfloat width,
        jfloat height
...
extern "C" JNIEXPORT void JNICALL
Java_huizai_ffmpeg_GLRenderer_RenderOneFrame(
        JNIEnv *env,
        jobject obj)
{
    pthread_mutex_lock(&mutex_lock);
...
extern "C" JNIEXPORT void JNICALL
Java_huizai_ffmpeg_AVPlayer_ThreadTest(
        JNIEnv *env,
        jobject obj,
        jstring input)
{
    jclass jcInfo = env->FindClass("huizai/ffmpeg/AVPlayer");
